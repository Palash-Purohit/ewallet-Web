...
<br>
			<form class="form-signin" action="LoginController" method="post">
				...
				<p  text-align: left;"> Fields marked with asterisk(<span style="color:red">*</span>) are compulsary Fields.
					...
					<tr>
						...
						<td>
				<input type="number" name="mobile" id="firstname"
					class="form-control" placeholder="Mobile No."  required autofocus> </td>
					</tr>
					<br>
					...
					<tr>
						<td></td>
						<td><a href="${pageContext.request.contextPath}/forgotpass.jsp" style="color:black">Forgot Password</a></td>
					</tr>
					<tr>
						<td></td>
		...
		<!-- footer -->
			<div id="footer">
				...
				<p class="copy">&copy; Copyright 2016<span>|</span>Fast Track Policy. Design by AHD_24 Aja113</p>
				<div class="cl">&nbsp;</div>
			</div>
			<!-- end of footer -->
		</div>
